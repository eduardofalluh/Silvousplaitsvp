/**
 * Tag a known contact by email. Used for funnel signals such as
...
exports.handler = async (event) => {
  ...
  if (!AC_API_URL || !AC_API_KEY) return { statusCode: 500, headers, body: JSON.stringify({ error: 'Contact system not configured' }) };
